    ...
    <div class="flex min-h-full items-center justify-center px-4 py-8">
        <div class="modal-panel w-full max-w-md rounded-2xl border border-white/10 bg-slate-900/95 p-6 shadow-2xl shadow-black/40">
            <div class="mb-5 flex items-start justify-between gap-4">
                <h2 class="text-lg font-semibold text-white">Editar sonho</h2>
                <button
                    type="button"
                    data-modal-close
            ...
            <form id="edit-sonho-form" class="space-y-4">
                <div>
                    <label for="edit-sonho-title" class="mb-1.5 block text-sm font-medium text-slate-300">Título</label>
                    <input
                        id="edit-sonho-title"
                        type="text"
                        name="title"
