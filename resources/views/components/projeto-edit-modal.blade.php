    ...
    <div class="flex min-h-full items-center justify-center px-4 py-8">
        <div class="modal-panel w-full max-w-md rounded-2xl border border-white/10 bg-slate-900/95 p-6 shadow-2xl shadow-black/40">
            <div class="mb-5 flex items-start justify-between gap-4">
                <h2 class="text-lg font-semibold text-white">Editar projeto</h2>
                <button
                    type="button"
                    data-modal-close
            ...
            <form id="edit-projeto-form" class="space-y-4">
                <div>
                    <label for="edit-projeto-title" class="mb-1.5 block text-sm font-medium text-slate-300">Título</label>
                    <input
                        id="edit-projeto-title"
                        type="text"
                        name="title"
                        required
                        maxlength="255"
                ...
                <div>
                    <label for="edit-projeto-description" class="mb-1.5 block text-sm font-medium text-slate-300">Objetivo</label>
                    <textarea
                        id="edit-projeto-description"
                        name="description"
                        rows="3"
                        maxlength="2000"
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label for="edit-projeto-starts-at" class="mb-1.5 block text-sm font-medium text-slate-300">Início</label>
                        <input
                            id="edit-projeto-starts-at"
                            type="date"
                            name="starts_at"
                    ...
                    <div>
                        <label for="edit-projeto-due-at" class="mb-1.5 block text-sm font-medium text-slate-300">Prazo</label>
                        <input
                            id="edit-projeto-due-at"
                            type="date"
                            name="due_at"
                            class="w-full rounded-lg border border-white/10 bg-slate-950/60 px-3 py-2.5 text-sm text-white outline-none transition focus:border-indigo-400/50 focus:ring-2 focus:ring-indigo-400/20 scheme-dark"
                        >
